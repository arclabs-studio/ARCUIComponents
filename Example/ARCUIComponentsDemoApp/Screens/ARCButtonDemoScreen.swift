        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(spacing: 12) {
                styleRow("Primary", description: "High emphasis CTA") {
                    ARCButton("Get Started", configuration: .primary) {}
                }

                styleRow("Secondary", description: "Medium emphasis") {
                    ARCButton("Learn More", configuration: .secondary) {}
                }

                styleRow("Destructive", description: "Dangerous actions") {
                    ARCButton("Delete Account", configuration: .destructive) {}
                }
