...
struct ARCEmptyStateConfigurationTests {
    ...
    @Test("noFavorites_hasCorrectTitle") func noFavorites_hasCorrectTitle() {
        let config = ARCEmptyStateConfiguration.noFavorites

        #expect(config.title == "No Favorites Yet")
    }

    @Test("noFavorites_showsAction") func noFavorites_showsAction() {
        let config = ARCEmptyStateConfiguration.noFavorites

        #expect(config.showsAction == true)
    }

    @Test("noFavorites_hasPinkAccentColor") func noFavorites_hasPinkAccentColor() {
        let config = ARCEmptyStateConfiguration.noFavorites
    ...
    @Test("noResults_hasCorrectIcon") func noResults_hasCorrectIcon() {
        let config = ARCEmptyStateConfiguration.noResults

        #expect(config.icon == "magnifyingglass")
    }

    @Test("noResults_hasCorrectTitle") func noResults_hasCorrectTitle() {
        let config = ARCEmptyStateConfiguration.noResults

        #expect(config.title == "No Results")
    }

    @Test("noResults_doesNotShowAction") func noResults_doesNotShowAction() {
        let config = ARCEmptyStateConfiguration.noResults
    ...
    @Test("error_hasCorrectIcon") func error_hasCorrectIcon() {
        let config = ARCEmptyStateConfiguration.error

        #expect(config.icon == "exclamationmark.triangle")
    }

    @Test("error_hasCorrectTitle") func error_hasCorrectTitle() {
        let config = ARCEmptyStateConfiguration.error

        #expect(config.title == "Something Went Wrong")
    }

    @Test("error_showsAction") func error_showsAction() {
        let config = ARCEmptyStateConfiguration.error

        #expect(config.showsAction == true)
    }

    @Test("error_hasRetryActionTitle") func error_hasRetryActionTitle() {
        let config = ARCEmptyStateConfiguration.error

        #expect(config.actionTitle == "Try Again")
    }

    @Test("error_hasOrangeAccentColor") func error_hasOrangeAccentColor() {
        let config = ARCEmptyStateConfiguration.error
    ...
    @Test("offline_hasCorrectIcon") func offline_hasCorrectIcon() {
        let config = ARCEmptyStateConfiguration.offline

        #expect(config.icon == "wifi.slash")
    }

    @Test("offline_hasCorrectTitle") func offline_hasCorrectTitle() {
        let config = ARCEmptyStateConfiguration.offline

        #expect(config.title == "No Connection")
    }

    @Test("offline_showsAction") func offline_showsAction() {
        let config = ARCEmptyStateConfiguration.offline

        #expect(config.showsAction == true)
    }

    @Test("offline_hasSettingsActionTitle") func offline_hasSettingsActionTitle() {
        let config = ARCEmptyStateConfiguration.offline
    ...
    @Test("noData_hasCorrectIcon") func noData_hasCorrectIcon() {
        let config = ARCEmptyStateConfiguration.noData

        #expect(config.icon == "tray")
    }

    @Test("noData_hasCorrectTitle") func noData_hasCorrectTitle() {
        let config = ARCEmptyStateConfiguration.noData

        #expect(config.title == "No Data")
    }

    @Test("noData_doesNotShowAction") func noData_doesNotShowAction() {
        let config = ARCEmptyStateConfiguration.noData
    ...
    @Test("init_withCustomIcon_setsIconCorrectly") func init_withCustomIcon_setsIconCorrectly() {
        let config = ARCEmptyStateConfiguration(icon: "photo",
                                                title: "No Photos",
    ...
    @Test("init_withCustomTitle_setsTitleCorrectly") func init_withCustomTitle_setsTitleCorrectly() {
        let config = ARCEmptyStateConfiguration(icon: "doc",
                                                title: "Custom Title",
    ...
    @Test("init_withCustomMessage_setsMessageCorrectly") func init_withCustomMessage_setsMessageCorrectly() {
        let config = ARCEmptyStateConfiguration(icon: "doc",
                                                title: "Title",
    ...
    @Test("init_withShowsActionTrue_showsAction") func init_withShowsActionTrue_showsAction() {
        let config = ARCEmptyStateConfiguration(icon: "doc",
                                                title: "Title",
                                                message: "Message",
                                                showsAction: true)
    ...
    @Test("init_withCustomAccentColor_setsColorCorrectly") func init_withCustomAccentColor_setsColorCorrectly() {
        let config = ARCEmptyStateConfiguration(icon: "doc",
                                                title: "Title",
                                                message: "Message",
                                                accentColor: .green)
    ...
    @Test("init_withCustomIconColor_setsIconColorCorrectly") func init_withCustomIconColor_setsIconColorCorrectly() {
        let config = ARCEmptyStateConfiguration(icon: "doc",
                                                iconColor: .purple,
                                                title: "Title",
                                                message: "Message")
    ...
    @Test("init_withDefaultValues_hasCorrectDefaults") func init_withDefaultValues_hasCorrectDefaults() {
        let config = ARCEmptyStateConfiguration(icon: "doc",
                                                title: "Title",
                                                message: "Message")
    ...
    @Test("premium_hasLiquidGlassBackgroundStyle") func premium_hasLiquidGlassBackgroundStyle() {
    ...
    @Test("premium_hasPurpleAccentColor") func premium_hasPurpleAccentColor() {
        let config = ARCEmptyStateConfiguration.premium
    ...
    @Test("init_withLiquidGlassStyle_setsStyleCorrectly") func init_withLiquidGlassStyle_setsStyleCorrectly() {
        let config = ARCEmptyStateConfiguration(icon: "star",
                                                title: "Test",
