...
@available(iOS 17.0, macOS 14.0, *) public struct ARCBarChartShowcase: View {
    public init() {}
    ...
    private var verticalSection: some View {
        VStack(alignment: .leading, spacing: .arcSpacingLarge) {
            ...
            ARCBarChart(data: ShowcaseBarData.priceRanges,
                        label: \.name,
                        value: \.count)
        }
    }
    ...
    private var verticalWithColorsSection: some View {
        VStack(alignment: .leading, spacing: .arcSpacingLarge) {
            ...
            ARCBarChart(data: ShowcaseBarData.coloredRanges,
                        label: \.name,
                        value: \.count,
                        color: { $0.color })
        }
    ...
    private var horizontalSection: some View {
        VStack(alignment: .leading, spacing: .arcSpacingLarge) {
            ...
            ARCBarChart(data: ShowcaseBarData.cities,
                        label: \.name,
                        value: \.count,
...
@available(iOS 17.0, macOS 14.0, *) private enum ShowcaseBarData {
