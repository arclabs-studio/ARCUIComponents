...
/// ```
@available(iOS 17.0, macOS 14.0, *) public struct ARCOnboardingConfiguration: Sendable, LiquidGlassConfigurable {
    ...
    public init(showSkipButton: Bool = true,
...
@available(iOS 17.0, macOS 14.0, *) extension ARCOnboardingConfiguration {
...
@available(iOS 17.0, macOS 14.0, *) extension ARCOnboardingConfiguration {
    ...
    /// - Fade transitions
    public static let minimal = ARCOnboardingConfiguration(showSkipButton: false,
    ...
    public static let prominent = ARCOnboardingConfiguration(buttonStyle: .glass,
                                                             indicatorStyle: .lines,
                                                             imageHeight: 0.4,
    ...
    /// - Progress indicator
    /// - Smaller image area
    public static let compact = ARCOnboardingConfiguration(showBackButton: false,
                                                           buttonStyle: .text,
