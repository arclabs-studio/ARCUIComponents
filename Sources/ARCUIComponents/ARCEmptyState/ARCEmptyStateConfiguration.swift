...
/// )
/// ```
@available(iOS 17.0, *) public struct ARCEmptyStateConfiguration: Sendable, LiquidGlassConfigurable {
    // MARK: - Properties
    ...
    public static let noResults = ARCEmptyStateConfiguration(icon: "magnifyingglass",
                                                             iconColor: .secondary,
                                                             title: "No Results",
                                                             message: "Try adjusting your search to find"
    ...
    public static let noData = ARCEmptyStateConfiguration(icon: "tray",
                                                          iconColor: .secondary,
                                                          title: "No Data",
    ...
    public static let noFavorites = ARCEmptyStateConfiguration(icon: "heart",
                                                               iconColor: .pink,
    ...
    public static let error = ARCEmptyStateConfiguration(icon: "exclamationmark.triangle",
                                                         iconColor: .orange,
    ...
    public static let offline = ARCEmptyStateConfiguration(icon: "wifi.slash",
                                                           iconColor: .red,
                                                           title: "No Connection",
    ...
    public static let premium = ARCEmptyStateConfiguration(icon: "sparkles",
                                                           iconColor: .purple,
                                                           title: "No Content",
