...
@available(iOS 17.0, macOS 14.0, *) public struct ARCCardShowcase: View {
    // MARK: - State
...
@available(iOS 17.0, macOS 14.0, *) private struct ConfigurationRow: View {
    let name: String
    let features: [String]
