...
@available(iOS 17.0, macOS 14.0, *) private struct MockRecommendation: AIRecommenderItem {
    let id: UUID
    let title: String
    let subtitle: String?
    let rating: Double?
...
#Preview("AI Recommender - Quick Mode") {
    ...
    let items: [MockRecommendation] = [MockRecommendation(id: UUID(),
                                                          title: "Item 1",
                                                          subtitle: "Categoría · €€",
                                                          rating: 8.5,
    ...
    NavigationStack {
        ARCAIRecommender(selectedCategory: $selected,
                         items: items)
...
#Preview("AI Recommender - Dark Mode") {
    ...
    NavigationStack {
        ARCAIRecommender<MockRecommendation>(mode: $mode,
                                             selectedCategory: $selected,
                                             questions: previewQuestions,
                                             answers: $answers,
                                             items: [],
