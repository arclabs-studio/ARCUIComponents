...
@available(iOS 17.0, macOS 14.0, *) enum ShowcasePreset: String, CaseIterable, Identifiable {
    case `default`
    case minimal
    case compact
    case list
...
@available(iOS 17.0, macOS 14.0, *) struct ShowcaseMockItem: AIRecommenderItem {
    let id: UUID
    let title: String
    var subtitle: String?
    var rating: Double?
...
@available(iOS 17.0, macOS 14.0, *) extension ARCAIRecommenderShowcase {
    ...
    var sampleQuestions: [AIRecommenderQuestion] {
        [AIRecommenderQuestion(id: "preference",
                               text: "¿Qué te apetece?",
                               subtitle: "Selecciona una o varias opciones",
                               options: [.init(id: "option1", label: "Opción A", icon: "star.fill", color: .orange),
                               ...
                               icon: "sparkles",
                               freeTextPlaceholder: "Añade algo específico (opcional)"),
         AIRecommenderQuestion(id: "location",
                               text: "¿Dónde te encuentras?",
                               options: [.init(id: "nearby", label: "Cerca de mí", icon: "location.fill", color: .blue),
         ...
         AIRecommenderQuestion(id: "budget",
                               ...
                               options: [.init(id: "low", label: "Bajo", icon: "dollarsign", color: .green),
