...
@available(iOS 17.0, macOS 14.0, *) struct AIRecommenderQuestionnaire: View {
    // MARK: - Properties
            ...
            ScrollView {
                VStack(spacing: .arcSpacingMedium) {
                    ...
                    ForEach(Array(questions.enumerated()), id: \.element.id) { index, question in
                        AIRecommenderQuestionCard(question: question,
                                                  answers: $answers,
                                                  configuration: configuration)
                            .opacity(hasAppeared ? 1 : 0)
                            .offset(y: hasAppeared ? 0 : 20)
                            .animation(.arcSpring.delay(Double(index) * 0.1),
                                       value: hasAppeared)
                    }
                }
        ...
        HStack(spacing: .arcSpacingSmall) {
            ...
            HStack(spacing: 4) {
                ForEach(questions) { question in
                    Circle()
                        .fill(answers.hasAnswer(for: question.id)
...
private let previewQuestions: [AIRecommenderQuestion] = [AIRecommenderQuestion(id: "preferences",
                                                                               text: "¿Qué te apetece?",
                                                         ...
                                                         AIRecommenderQuestion(id: "mood",
                                                                               ...
                                                                               subtitle: "Tu estado de ánimo influye"
                                                                                   + " en la recomendación",
...
#Preview("Questionnaire") {
    ...
    NavigationStack {
        AIRecommenderQuestionnaire(questions: previewQuestions,
                                   answers: $answers,
