...
///
/// // With loading state
/// ARCButton("Save", isLoading: $isSaving) {
///     await saveChanges()
/// }
///
/// // With icon
...
///
/// // Destructive action
/// ARCButton("Delete", icon: "trash", configuration: .destructive) {
///     deleteItem()
/// }
/// ```
...
public struct ARCButton: View {
    ...
    private let configuration: ARCButtonConfiguration
    ...
    public var body: some View {
        ...
        .buttonStyle(ARCButtonStyle(buttonConfiguration: configuration, isLoading: isLoading))
...
#Preview("With Icons") {
    VStack(spacing: 16) {
        ...
        ARCButton("Share", icon: "square.and.arrow.up", iconPosition: .trailing) {}
        ARCButton(icon: "plus") {}
    }
    .padding()
}
...
#Preview("Glass Style") {
    ZStack {
        ...
        VStack(spacing: 16) {
            ...
            ARCButton("Apply Filter", icon: "slider.horizontal.3", configuration: .glass) {}
        }
        .padding()
    }
}
