...
ARCActionButton("Save Changes", isLoading: $isSaving) {
    isSaving = true
    await saveChanges()
    isSaving = false
}
...
```swift
// Primary (default)
ARCActionButton("Submit", configuration: .primary) { }

// Secondary
ARCActionButton("Cancel", configuration: .secondary) { }
...
// Glass
ARCActionButton("Apply", configuration: .glass) { }
```
...
- <doc:ARCActionButtonConfiguration>
