//
//  ARCActionButtonConfiguration.swift
//  ARCUIComponents
//
...
// MARK: - ARCActionButtonConfiguration

/// Configuration for ARCActionButton appearance and behavior
///
...
/// ## Overview
///
/// ARCActionButton is designed for CTAs, form submissions, and important actions.
...
public struct ARCActionButtonConfiguration: LiquidGlassConfigurable, Sendable {
    // MARK: - Style
    ...
    public init(
        ...
        self.backgroundStyle = style == .glass ? .liquidGlass : .solid(color, opacity: 1.0)
    ...
    public static let primary = ARCActionButtonConfiguration(
        style: .filled,
        color: .accentColor
    )
    ...
    public static let secondary = ARCActionButtonConfiguration(
        style: .outlined,
        color: .accentColor,
        shadow: .none
    )
    ...
    public static let destructive = ARCActionButtonConfiguration(
        style: .filled,
        color: .red
    )
    ...
    public static let ghost = ARCActionButtonConfiguration(
        style: .ghost,
        color: .accentColor,
        shadow: .none
    )
    ...
    public static let glass = ARCActionButtonConfiguration(
        style: .glass,
        color: .primary,
        shadow: .default
    )
    ...
    public static let small = ARCActionButtonConfiguration(
        size: .small
    )

    /// Large button preset (56pt height)
    public static let large = ARCActionButtonConfiguration(
        size: .large
    )

    /// Square icon-only button
    public static let iconOnly = ARCActionButtonConfiguration(
        style: .filled,
        size: .medium
    )
